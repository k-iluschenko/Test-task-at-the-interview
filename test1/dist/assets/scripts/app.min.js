...
/***/ (function(module, exports, __webpack_require__) {
	...
	level1.onclick = function (e) {
		var xx = e.pageX - ((document.documentElement.clientWidth - 1000) / 2 + 112) - thumb.offsetWidth / 2;
		if (xx < 52) {
			thumb.style.left = 2 - thumb.offsetWidth / 2 + 'px';
		}
	};
	
	level2.onclick = function (e) {
		var xx = e.pageX - ((document.documentElement.clientWidth - 1000) / 2 + 112) - thumb.offsetWidth / 2;
		if (xx < 310) {
			thumb.style.left = '134px';
		}
	};
	
	level3.onclick = function (e) {
		var xx = e.pageX - ((document.documentElement.clientWidth - 1000) / 2 + 112) - thumb.offsetWidth / 2;
		if (xx < 540) {
			thumb.style.left = '358px';
		}
	...
	level4.onclick = function (e) {
		var xx = e.pageX - ((document.documentElement.clientWidth - 1000) / 2 + 112) - thumb.offsetWidth / 2;
		if (xx < 770) {
			thumb.style.left = bg.offsetWidth - thumb.offsetWidth / 2 - 1 + 'px';
		}
	};
	...
	document.onmousemove = function (e) {
		...
		if (thumb.offsetLeft > 130 && thumb.offsetLeft < 150) {
			thumb.style.left = '132px';
		}
		if (thumb.offsetLeft > 356 && thumb.offsetLeft < 376) {
			thumb.style.left = '358px';
		}
		if (thumb.offsetLeft > 750) {
			thumb.style.left = bg.offsetWidth - thumb.offsetWidth / 2 - 1 + 'px';
		}
	};
